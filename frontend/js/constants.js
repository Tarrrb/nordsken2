...
const welcome_h2 = "Koppla din metamask";
const h1_presale_coming_soon = "Snart öppnar Blockmarknaden.se!";
const h1_presale_mint = "Nordsken NFT lotteri";
const h1_public_mint = "Nordskens NFT Lotteri";
const h2_presale_coming_soon = "kommer snart";
