...
const namePrefix = "Nordsken";
const description = "NFT lotteri";
...
const extraMetadata = {
  external_url: "https://blockmarknaden.se", // Replace with your website or remove this line if you do not have one.
};
...
const GENERIC_DESCRIPTION = "Kl 20.00"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeidj27jaksi6q3o5gu3iwiciil35b333b2ga5k7ifdql4zmc3z6u4m"; // Replace with your generic image that will display for all NFTs pre-reveal.
